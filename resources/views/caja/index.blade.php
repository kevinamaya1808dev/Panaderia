...
<div class="container-fluid px-4">
    ...
    @can('aperturar-caja')
    <div class="mb-4">
        <a href="{{ route('cajas.create') }}" class="btn btn-primary">Aperturar caja</a>
    </div>
    @endcan
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table id="table-cajas" class="table table-striped fs-6">
                <thead>
                    <tr>
                        <th>Nombre</th>
                        <th>Apertura</th>
            ...
            @include('layouts.partials.paginator', ['paginator' => $cajas])
        </div>
    </div>
</div>
@endsection
